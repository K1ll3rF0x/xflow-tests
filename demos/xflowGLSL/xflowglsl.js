(function () {
    ...
    (function () {
        ...
        XML3D.createClass(BlitPass, webgl.BaseRenderPass, {
            ...
            renderOnce: function (image, shader) {
                ...
                program2.setUniformVariables({ inputTexture: texture, canvasSize: textureTest});
    ...
    XML3D.shaders.register("flipTexture", {
        ...
        vertex: [
            ...
            " vTextureCoord = aTextureCoord; //vec2(aTextureCoord.s, 1.0 - aTextureCoord.t);",
            "}"
        ].join("\n"),
    ...
    XML3D.shaders.register("grayscale", {
        ...
        fragment: [
            ...
            "void main(void)",
            "{",
            "vec4 frameColor = texture2D(inputTexture, vec2(vTextureCoord.s, vTextureCoord.t));",
